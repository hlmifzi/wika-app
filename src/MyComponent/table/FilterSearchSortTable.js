    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                key: 'profilePicture',
                width: 80,
                render: (text, value) => <img className="width-50" src={`public/uploads/profiles/${value.profilePicture || 'https://upload.wikimedia.org/wikipedia/en/b/b1/Portrait_placeholder.png'}`} />
            },
            {
                title: 'Nama',
                dataIndex: 'name',
