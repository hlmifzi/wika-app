...
export const addNewPosition = (body) => clientPost(`position`, body)
export const addNewFieldFunction = (body) => clientPost(`fieldFunction`, body)
export const addNewJabatan = (body) => clientPost(`workUnit`, body)