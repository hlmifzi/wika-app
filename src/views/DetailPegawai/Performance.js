...
export const Performance = ({ children, color, text }) => {
  return (
    <CardWithCustom classHeader={"bg-primary text-white"} text="Performance">
      ...
      <Row className="card-custom">
        ...
        <Col xs="12" sm="6" lg="3">
            <Widget02 header="80" mainText="Teori" icon="fa fa-pencil-square-o" color="primary" variant="1" />
        </Col>
        <Col xs="12" sm="6" lg="3">
            <Widget02 header="90" mainText="Praktek" icon="fa fa-cog" color="info" variant="1" />
        </Col>
        <Col xs="12" sm="6" lg="3">
            <Widget02 header="87.77" mainText="EK" icon="fa fa-th-list" color="danger" variant="1" />
        </Col>
        <Col xs="12" sm="6" lg="3">
            <Widget02 header="85.55" mainText="PK" icon="fa fa-wrench" color="success" variant="1" />
        </Col>
      </Row>
    </CardWithCustom>
  )
